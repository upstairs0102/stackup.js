...
# First of all, embed following files below on your html file:
...
(1)same file path case:
 view name: ‘home’ -> file name: ‘home.html’

(2)different file path case:
...
view:
{
    getter:{THE PARAMETERS FROM LAST VIEW},
    loading:{
...
stackup.first(“VIEW NAME”,{TRANSFER PARAMETERS}) //parameters depends on your demand
